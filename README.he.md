...
| **3. כרטיסים** | כרטיסי כותרת וכיתוב בעברית/RTL (כולל מלכודת הספרות וה-`?`). |
| **4. קבוצות ותמונות אמיתיות** | סצנת סיום כיתתית, שחזור אירועים, ושילוב תמונות אמיתיות. |
| **5. מוזיקה** | בחירת מוזיקה חופשית לשימוש (עם קרדיט בכרטיס הסיום). |
| **6. הרכבה ואימות** | רינדור במקטעים, ואז **לוודא שאורך הווידאו == אורך האודיו**. |
